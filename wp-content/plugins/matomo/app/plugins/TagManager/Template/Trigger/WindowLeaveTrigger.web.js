(function(){return function(parameters,TagManager){var numTriggers=0;this.setUp=function(triggerEvent){TagManager.dom.onReady(function(){if(!parameters.document.documentElement){return;}
