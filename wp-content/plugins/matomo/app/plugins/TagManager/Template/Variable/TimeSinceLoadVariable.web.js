(function(){return function(parameters,TagManager){this.get=function(){var unit=parameters.get('unit','ms');var now=new Date().getTime();var loadTime=TagManager.dataLayer.get('mtm.mtmScriptLoadedTime');if(!loadTime){loadTime=TagManager.dataLayer.get('mtm.startTime');}
